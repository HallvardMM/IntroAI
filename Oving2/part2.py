"""File for part 2 the cells will have different costs attached to them """
...
map3.show_map() # Prints map task 3 before A*
endNode3 = astar(map3, combinedHeuristic)
backTrack(endNode3, map3) # Prints map task 3 after A*

map4.show_map() # Prints map task 4 before A*
endNode4 = astar(map4, combinedHeuristic)
backTrack(endNode4, map4) # Prints map task 4 after A*
